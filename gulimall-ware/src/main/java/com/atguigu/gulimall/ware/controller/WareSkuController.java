...
public class WareSkuController {
    ...
    public R orderLockStock(@RequestBody WareLockVo lockVo){

        try{
            Boolean b = wareSkuService.orderLockStock(lockVo);
            return R.ok();
        }catch(Exception e){
            return R.error(BizCodeEnume.NO_STOCK_EXCEPTION.getCode(),BizCodeEnume.NO_STOCK_EXCEPTION.getMag());
        }
